              ...
              <form onSubmit={handleAddFav} className="border-2 border-amber-400/80 rounded-2xl p-3 flex flex-wrap items-center gap-2 bg-amber-50/40 backdrop-blur-[2px] shadow-sm shrink-0">
                <div className="relative">
                  <input
                    ...
                    placeholder="분류 (예: 포털)"
                    className="w-24 border border-amber-200 bg-white/90 rounded-lg px-2.5 py-1.5 text-xs font-medium text-amber-950 focus:outline-none focus:border-amber-500 placeholder-neutral-400"
                  />
